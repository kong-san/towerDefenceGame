System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, diji, _dec, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, BulletPerManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletPerManeger", BulletPerManeger = (_dec = ccclass('BulletPerManeger'), _dec(_class = (_class2 = class BulletPerManeger extends Component {
        ...
        PaoBullet(deltaTime) {
          let x = this.node.position.x;
          let y = this.node.position.y; // console.log("子弹的角度是",this.angle/Math.PI * 180)

          if (this.node.parent.parent.parent.parent.name == "blockRight") {
...
//# sourceMappingURL=f277838faef3d5289db47e5b4d6c45fe8d48ca1e.js.map