        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              console.log('炮节点已存在，正在移动'); // this.node.parent.parent.getChildByName('pao1').destroy();
            } else {
              ...
              resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                node.layer = Layers.Enum.UI_2D; // node.setPosition(event.)
                // console.log(node);
...
//# sourceMappingURL=0a17851951357127186aa6614ac7da398debaef0.js.map