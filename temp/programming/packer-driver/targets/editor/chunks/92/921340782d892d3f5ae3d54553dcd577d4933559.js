System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, find, Label, combatConfigManeger, PaoPerManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, updateComponent;
      ...
      _export("updateComponent", updateComponent = (_dec = ccclass('updateComponent'), _dec2 = property(Node), _dec(_class = (_class2 = class updateComponent extends Component {
        ...
        clickIcon() {
          ...
          if (this.node.name == "update") {
            this.updateNode(this.targetNode);
          }
        }
        ...
        updateNode(node) {
          ...
          if (nodeAlias.isValid) {
            ...
            node.getComponent(_crd && PaoPerManeger === void 0 ? (_reportPossibleCrUseOfPaoPerManeger({
              error: Error()
            }), PaoPerManeger) : PaoPerManeger).refreshData();
            let level = node.getComponent(_crd && PaoPerManeger === void 0 ? (_reportPossibleCrUseOfPaoPerManeger({
              error: Error()
            }), PaoPerManeger) : PaoPerManeger).SanShePaoLivSysMag.gradeValue;
            nodeAlias.parent.getChildByName("level").getComponent(Label).string = "L" + level;
          }
        }
...
//# sourceMappingURL=921340782d892d3f5ae3d54553dcd577d4933559.js.map