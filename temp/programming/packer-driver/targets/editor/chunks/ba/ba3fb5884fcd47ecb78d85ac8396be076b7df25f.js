System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, Vec2, BoxCollider2D, _dec, _class, _crd, ccclass, property, pao;
    ...
    execute: function () {
      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec(_class = class pao extends Component {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                console.log(node.getComponent(BoxCollider2D)); // node.addComponent(locationPyManeger);
        ...
        nodeTouchCancel(event) {
          console.log('已取消触摸事件');
          this.node.parent.parent.parent.getChildByName('pao1').destroy();
        }
...
//# sourceMappingURL=ba3fb5884fcd47ecb78d85ac8396be076b7df25f.js.map