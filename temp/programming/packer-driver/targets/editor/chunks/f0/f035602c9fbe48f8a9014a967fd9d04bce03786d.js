System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, find, Label, _dec, _class, _crd, ccclass, property, talkManeger;
    ...
    execute: function () {
      ...
      _export("talkManeger", talkManeger = (_dec = ccclass('talkManeger'), _dec(_class = class talkManeger extends Component {
        ...
        talkContinue() {
          ...
          if (this.step == this.message.length) {} else {
...
//# sourceMappingURL=f035602c9fbe48f8a9014a967fd9d04bce03786d.js.map