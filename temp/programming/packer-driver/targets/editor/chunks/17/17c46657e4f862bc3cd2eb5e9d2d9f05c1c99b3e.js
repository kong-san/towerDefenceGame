      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          for (let i = 0; i < this.bulletArray.length; i++) {
            ...
            if (this.targetArray.length > 0) {// x = x + this.DijiLivSysMag.attackSpeed * deltaTime;
              // this.shenmuTarget = true;
            } else {// this.shenmuTarget = false;
            } // else{
            //     if(i%3 == 1){
...
//# sourceMappingURL=17c46657e4f862bc3cd2eb5e9d2d9f05c1c99b3e.js.map