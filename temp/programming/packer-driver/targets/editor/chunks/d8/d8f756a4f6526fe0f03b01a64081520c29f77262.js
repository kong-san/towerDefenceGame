      ...
      _export("BulletPerManeger", BulletPerManeger = (_dec = ccclass('BulletPerManeger'), _dec(_class = (_class2 = class BulletPerManeger extends Component {
        ...
        update(deltaTime) {
          ...
          if (x > 800 || x < -800 || y > 450 || y < -450) {
            ...
            this.node.destroy(); // console.log('this bullet over screen')
          }
        }
        ...
        FengYiBullet(deltaTime) {
          let x = this.node.position.x;
          let y = this.node.position.y;
          x = x - this.speed * deltaTime; // y = y + this.speed * deltaTime;
        }
...
//# sourceMappingURL=d8f756a4f6526fe0f03b01a64081520c29f77262.js.map