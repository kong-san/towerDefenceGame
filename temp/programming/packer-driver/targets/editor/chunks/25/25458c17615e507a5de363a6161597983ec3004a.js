  ...
  return {
    ...
    execute: function () {
      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        ...
        endGame() {
          let node = find("Canvas/model");
          node.getChildByName("info").getComponent(Label).string = "游戏结束";
        }
...
//# sourceMappingURL=25458c17615e507a5de363a6161597983ec3004a.js.map