  ...
  return {
    ...
    execute: function () {
      ...
      _export("dijiDeathPerManeger", dijiDeathPerManeger = (_dec = ccclass('dijiDeathPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        start() {
          this.initialDijiDeath(); // let that = this;
        ...
        update(deltaTime) {
          ...
          x = x + 1000 * deltaTime; // y = y - 10 * deltaTime;
        ...
        initialDijiDeath() {
          this.DijiDeathLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(100, 10, 10, 12, 100); // let that = this;
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "PaoBulletPer") {
            if (this.DijiDeathLivSysMag.livingValue - 40 <= 0) {
              this.node.parent.destroy();
            } else {
              this.DijiDeathLivSysMag.livingValue -= 40; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
          ...
          if (Collider.node.name == "GuangZiBulletPer") {
            if (this.DijiDeathLivSysMag.livingValue - 80 <= 0) {
              this.node.parent.destroy();
            } else {
              this.DijiDeathLivSysMag.livingValue -= 80; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=c1c630ad31a9e13b6451bc93de9417643c912798.js.map