System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FengyiPerManeger", FengyiPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        error: Error()
        ...
        initialFengyi() {
          this.FengyiLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(100, 10, 10, 3, 300); // let that = this;
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            // console.log("我军受到攻击")
            if (this.FengyiLivSysMag.livingValue - 80 <= 0) {
              this.node.parent.destroy();
            } else {
              this.FengyiLivSysMag.livingValue -= 80; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)

              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * (this.FengyiLivSysMag.livingValue / 100);
            }
          }
        } //生成子弹
...
//# sourceMappingURL=4e34ec1a7bd1662e27291b9a104cc2daaed45cbf.js.map