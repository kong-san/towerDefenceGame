    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec(_class = class diji extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          // this.hasEmeny = true;
          this.targetArray.push(otherCollider.node.position); // console.log("maybe a information about position",otherCollider.node.position)
...
//# sourceMappingURL=a7c1f3366a5e12ce3aaa4514e510b19f56ab5f18.js.map