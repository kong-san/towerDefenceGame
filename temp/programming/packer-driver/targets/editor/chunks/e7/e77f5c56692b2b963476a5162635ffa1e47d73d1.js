System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, _dec, _class, _crd, ccclass, property, PaoPerManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec(_class = class PaoPerManeger extends Component {
        ...
        createBullet(that) {
          let node = new Node(); // node.addComponent(Sprite);

          resources.load("perfabs/Bullet_Pre"); // resources.load('zidan1/spriteFrame',SpriteFrame,(_err,sproteFarme)=>{
...
//# sourceMappingURL=e77f5c56692b2b963476a5162635ffa1e47d73d1.js.map