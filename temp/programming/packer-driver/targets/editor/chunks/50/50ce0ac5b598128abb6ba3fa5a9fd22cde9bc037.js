      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec(_class = class pao extends Component {
        start() {
          this.node.on(Node.EventType.MOUSE_DOWN, event => {
            ...
            node.getComponent(Sprite).spriteFrame = new SpriteFrame("resources/game/wenzikuang/wenzikuang");
...
//# sourceMappingURL=50ce0ac5b598128abb6ba3fa5a9fd22cde9bc037.js.map