      ...
      _export("DanPerManeger", DanPerManeger = (_dec = ccclass('DanPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            // console.log("我军受到攻击")
            if (this.DanLivSysMag.livingValue - 80 <= 0) {
              this.node.parent.destroy();
            } else {
              this.DanLivSysMag.livingValue -= 80; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=12c979fda81bc6cae0c5a49e043d5a8e441d8b60.js.map