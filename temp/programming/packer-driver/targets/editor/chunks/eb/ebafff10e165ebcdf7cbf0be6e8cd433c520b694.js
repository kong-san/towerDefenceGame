System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, AudioSource, find, _dec, _class, _crd, ccclass, property, loadManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("loadManeger", loadManeger = (_dec = ccclass('loadManeger'), _dec(_class = class loadManeger extends Component {
        ...
        begin() {
          console.log(find("Canvas").getComponent(AudioSource));
          find("Canvas").getComponent(AudioSource).stop; //

          this.schedule(function () {
            this.node.getComponent(AudioSource).play; // director.loadScene("preIntroduce")
          }, 1, 0, 0);
        }
...
//# sourceMappingURL=ebafff10e165ebcdf7cbf0be6e8cd433c520b694.js.map