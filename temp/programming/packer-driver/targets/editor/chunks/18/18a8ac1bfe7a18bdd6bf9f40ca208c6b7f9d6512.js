System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'SpriteFrame', 'resources', 'director', 'Layers', 'Scene', 'UITransform', 'Vec3', 'Vec2']);
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                node.layer = Layers.Enum.UI_2D;
                node.setScale(0.5, 0.5, 1); // node.setPosition(event.touch.point.x)
                // console.log(node);
...
//# sourceMappingURL=18a8ac1bfe7a18bdd6bf9f40ca208c6b7f9d6512.js.map