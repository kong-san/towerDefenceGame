    ...
    execute: function () {
      ...
      _export("toolPyManeger", toolPyManeger = (_dec = ccclass('toolPyManeger'), _dec(_class = class toolPyManeger extends Component {
        ...
        onEndContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体结束接触时被调用一次
          console.log('Tool onEndContact'); // selfCollider.node.getComponent(Sprite).color = Color.TRANSPARENT;
        }
        ...
        onPostSolve(selfCollider, otherCollider, contact) {
          // 每次处理完碰撞体接触逻辑时被调用
          console.log('Tool onPostSolve');
          selfCollider.node.destroy(); // selfCollider.node.getComponent(Sprite).color = Color.TRANSPARENT;
        }
...
//# sourceMappingURL=57d2158e86a425b52cea96699d2f3a8029d1c281.js.map