    ...
    execute: function () {
      ...
      _export("dijiTargetManeger", dijiTargetManeger = (_dec = ccclass('dijiTargetManeger'), _dec(_class = (_class2 = class dijiTargetManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.hasEmeny = true;
          let targetPosition = otherCollider.node.getWorldPosition(otherCollider.node.position); // this.emenyArray.push(targetPosition);
...
//# sourceMappingURL=5792d01574cd471c308261721e090cc2f37c148c.js.map