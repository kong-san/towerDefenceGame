          ...
          resources.load("perfabs/Emeny2Perfabs", Prefab, (err, Prefab) => {
            if (!Prefab) {} else {
              ...
              that.schedule(function () {
                ...
                node.parent = find("Canvas/EmenyBox");
                node.active = true;
              }, 1, that.RoundEmenyConfig[currentRound - 1][1], 0);
            }
          });
          resources.load("perfabs/Emeny1Perfabs", Prefab, (err, Prefab) => {
            if (!Prefab) {} else {
              ...
              that.schedule(function () {
                ...
                node.parent = find("Canvas/EmenyBox");
                node.active = true;
              }, 1, that.RoundEmenyConfig[currentRound - 1][0], 0); // let node = instantiate(Prefab);
              // node.layer = Layers.Enum.UI_2D;
              // node.setPosition(0,0,0);
              // node.parent = find("Canvas/EmenyBox");
            }
          ...
          resources.load("perfabs/KongPerfabs", Prefab, (err, Prefab) => {
            if (!Prefab) {} else {
              ...
              that.schedule(function () {
                ...
                node.parent = find("Canvas/KongBoxL");
                node.active = true;
              }, 1, that.RoundEmenyConfig[currentRound - 1][2], 0); // let node = instantiate(Prefab);
              // node.layer = Layers.Enum.UI_2D;
              // node.setPosition(0,0,0);
              // node.parent = find("Canvas/EmenyBox");
            }
...
//# sourceMappingURL=379ad23923df191b104727b05f856042c676268d.js.map