    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          let x = node.position.x; // this.endGameFlag = find("Canvas/GlobalRoundcontrol").getComponent(combatConfigManeger).endGameFlag;
...
//# sourceMappingURL=074d3b476e49d2027bb74b77b59cc7664fb5bedb.js.map