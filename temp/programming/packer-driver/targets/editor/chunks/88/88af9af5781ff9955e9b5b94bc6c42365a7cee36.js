    ...
    execute: function () {
      ...
      _export("BulletPerManeger", BulletPerManeger = (_dec = ccclass('BulletPerManeger'), _dec(_class = (_class2 = class BulletPerManeger extends Component {
        ...
        update(deltaTime) {
          ...
          let y = this.node.position.y; //子弹的飞行和角度模式选择

          this.bulletAttack(deltaTime); //飞出屏幕外销毁子弹
        ...
        DanBullet(deltaTime) {
          ...
          let y1 = this.node.position.y; //关键是：currenTarget.isValid，获取塔防目前锁定的currentTarget是否有效，有效则进行攻击
...
//# sourceMappingURL=88af9af5781ff9955e9b5b94bc6c42365a7cee36.js.map