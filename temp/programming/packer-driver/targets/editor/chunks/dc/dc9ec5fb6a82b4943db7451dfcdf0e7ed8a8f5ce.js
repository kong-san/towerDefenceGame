        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.GuangziLivSysMag.livingValue - 80 <= 0) {
              ...
              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * (this.GuangziLivSysMag.livingValue / 100);
            }
          }
        } //生成子弹
...
//# sourceMappingURL=dc9ec5fb6a82b4943db7451dfcdf0e7ed8a8f5ce.js.map