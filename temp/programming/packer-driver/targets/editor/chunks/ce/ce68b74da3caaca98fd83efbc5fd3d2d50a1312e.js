        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              let pos = new Vec3(event.getLocationX(), event.getLocationY(), 0); //转换为UI作表

              pos = this.node.parent.parent.parent.getComponent(UITransform).convertToNodeSpaceAR(pos); // let x = event.touch._point['x']-450;
...
//# sourceMappingURL=ce68b74da3caaca98fd83efbc5fd3d2d50a1312e.js.map