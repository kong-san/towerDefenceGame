        ...
        update(deltaTime) {
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              let pos = new Vec3(event.getLocationX(), event.getLocationY()); // let pos = new Vec3(event.touch._point['x'],event.touch._point['y'],0);
              //转换为UI作表
...
//# sourceMappingURL=cf235a8604ba12f6fd5858cafb645fa06ed60af8.js.map