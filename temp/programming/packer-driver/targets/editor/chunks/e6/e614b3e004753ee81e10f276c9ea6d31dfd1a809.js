          ...
          if (toolname == "pao") {
            resources.load("perfabs/PaoPerfabs", Prefab, (err, Prefab) => {
              if (!Prefab) {} else {
                ...
                that.node.getComponent(Sprite).color = Color.TRANSPARENT; // node.getComponent(Sprite).color = Color.BLUE;
...
//# sourceMappingURL=e614b3e004753ee81e10f276c9ea6d31dfd1a809.js.map