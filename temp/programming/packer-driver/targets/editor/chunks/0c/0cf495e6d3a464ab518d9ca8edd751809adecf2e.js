        ...
        update(deltaTime) {
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              let pos = new Vec3(event.getLocationX(), event.getLocationY(), 0); // let pos = new Vec3(event.touch._point['x'],event.touch._point['y'],0);
              //转换为UI作表
...
//# sourceMappingURL=0cf495e6d3a464ab518d9ca8edd751809adecf2e.js.map