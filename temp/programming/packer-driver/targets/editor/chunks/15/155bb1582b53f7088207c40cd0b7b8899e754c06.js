      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        ...
        nextPage() {
          ...
          this.schedule(function () {
            ...
            console.log("error>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"); // find("Canvas/ShenMu").getChildByName("shenmu").getComponent(ShenMuManeger).refresh();
          }, 2, 1, 0);
        }
...
//# sourceMappingURL=155bb1582b53f7088207c40cd0b7b8899e754c06.js.map