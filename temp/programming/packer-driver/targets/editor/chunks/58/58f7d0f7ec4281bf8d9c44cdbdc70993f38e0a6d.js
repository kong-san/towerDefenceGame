System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, find, Prefab, resources, instantiate, Layers, toolPyManeger, _dec, _class, _class2, _descriptor, _crd, ccclass, property, locationPyManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PhysicsSystem2D', 'EPhysics2DDrawFlags', 'Collider2D', 'Contact2DType', 'IPhysics2DContact', 'BoxCollider2D', 'director', 'Sprite', 'Color', 'find', 'Prefab', 'resources', 'instantiate', 'Layers', 'color']);
      ...
      _export("locationPyManeger", locationPyManeger = (_dec = ccclass('locationPyManeger'), _dec(_class = (_class2 = class locationPyManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          console.log("空的名字是", otherCollider.node.name);
        ...
        update(deltaTime) {
          if (this.targetTool != "null") {
            ...
            let step = targetToolNode.getComponent(_crd && toolPyManeger === void 0 ? (_reportPossibleCrUseOftoolPyManeger({
              error: Error()
          ...
          if (toolname == "pao") {
            resources.load("perfabs/PaoPerfabs", Prefab, (err, Prefab) => {
              if (!Prefab) {} else {
                ...
                node.setPosition(0, 0, 0); // that.node.getComponent(Sprite).setEntityOpacity(0);
                // that.node.getComponent(Sprite).color = Color.TRANSPARENT;
...
//# sourceMappingURL=58f7d0f7ec4281bf8d9c44cdbdc70993f38e0a6d.js.map