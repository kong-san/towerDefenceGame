    ...
    execute: function () {
      ...
      _export("dijiTargetManeger", dijiTargetManeger = (_dec = ccclass('dijiTargetManeger'), _dec(_class = (_class2 = class dijiTargetManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.hasEmeny = true;
          let x = otherCollider.node.getWorldPosition(otherCollider.node.position); // let y = otherCollider.node.position.y;
          // let position = otherCollider.node.convertToWordspaceAR()

          console.log("出现目标,坐标x:", x);
        }
...
//# sourceMappingURL=456e4c3616a8bb76377d6e5105563695ec4b8c7d.js.map