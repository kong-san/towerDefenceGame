        ...
        update(deltaTime) {
          this.schedule(function () {
            if (this.currentLivingValue < this.ShenMuLivSysMag.livingValue) {
              this.currentLivingValue += this.growSpeed * deltaTime;
            ...
            if (this.currentLivingValue >= this.ShenMuLivSysMag.livingValue) {// console.log("通关成功，进入下一关")
...
//# sourceMappingURL=69ad17e7486cae9cf399c6a2993d50ad7ff7e1ec.js.map