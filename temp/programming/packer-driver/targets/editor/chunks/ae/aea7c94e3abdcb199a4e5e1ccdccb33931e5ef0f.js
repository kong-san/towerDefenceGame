  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShenMuManeger", ShenMuManeger = (_dec = ccclass('ShenMuManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          let that = this;
          let nextFLag = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).nextFLag;
          let endGameFlag = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).endGameFlag;
          let askRequest = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).askRequest;
          ...
          let callback = function () {
            ...
            if (that.currentLivingValue >= that.ShenMuLivSysMag.livingValue) {
              ...
              if (!that.refreshFlag) {
                that.refreshFlag = true; // that.refresh()
              ...
              if (!askRequest) {
                ...
                find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
                  error: Error()
                }), combatConfigManeger) : combatConfigManeger).askRequest = true;
              }
          ...
          if (!nextFLag && !endGameFlag) {
            console.log("ask ask ask ask ask ask ask");
        ...
        destroyThisNode() {
          find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).endGame(); // this.node.parent.destroy()
        }
        ...
        initialShenMu() {
          ...
          this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * (this.currentLivingValue / this.ShenMuLivSysMag.livingValue); // console.log("神木初始化成功")
        }

        underFire(Collider) {
          //判断是被谁攻击的
          let harmedValue1 = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).EmenyNormal.HarmValue;
          let harmedValue2 = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
...
//# sourceMappingURL=aea7c94e3abdcb199a4e5e1ccdccb33931e5ef0f.js.map