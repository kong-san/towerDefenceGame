      ...
      _export("updateComponent", updateComponent = (_dec = ccclass('updateComponent'), _dec2 = property(Node), _dec(_class = (_class2 = class updateComponent extends Component {
        ...
        updateNode(node) {
          ...
          if (nodeAlias.isValid) {
            ...
            console.log("升级前：", node.getComponent(_crd && PaoPerManeger === void 0 ? (_reportPossibleCrUseOfPaoPerManeger({
              error: Error()
            ...
            console.log("升级前：", node.getComponent(_crd && PaoPerManeger === void 0 ? (_reportPossibleCrUseOfPaoPerManeger({
              error: Error()
            }), PaoPerManeger) : PaoPerManeger).SanShePaoLivSysMag.gradeValue); // nodeAlias.parent.getChildByName("level").getComponent(Label).string = "L2"
          }
        }
...
//# sourceMappingURL=866d8fc5cd294297ff381b6b5efd2549706cbf2f.js.map