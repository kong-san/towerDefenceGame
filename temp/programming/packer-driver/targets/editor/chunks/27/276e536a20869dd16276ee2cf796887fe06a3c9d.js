System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, error, resources, Prefab, instantiate, Layers, find, Label, AudioClip, AudioSource, assert, ShenMuManeger, GlobalLivingClass, SanShePao, ZhuiZongDan, GuangZiJian, FengYiJun, EmenyNormal, EmenyQuickAttack, SHENMU, Bing, Kong, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, combatConfigManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'error', 'resources', 'Prefab', 'instantiate', 'Layers', 'find', 'Label', 'AudioClip', 'AudioSource', 'assert']);
      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec2 = property(AudioSource), _dec3 = property(AudioClip), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "_audioSource", _descriptor7, this);

          _initializerDefineProperty(this, "clip", _descriptor8, this);
        ...
        start() {
          ...
          this.schedule(function () {
            ...
            if (!that.nextFLag && !that.endGameFlag) {
              ...
              } // that._audioSource.clip = new AudioClip("music/zap1.ogg");


              that.clip = new AudioClip("zap1.ogg");
              that.playOneShot();
        ...
        endGame() {
          ...
          let nodeList = find("Canvas/EmenyBox").children; // for(let i =0;i<nodeList.length;i++){
        ...
        createSingleRoundEmenyRight(currentRound) {
          ...
          resources.load("perfabs/Emeny2Perfabs", Prefab, (err, Prefab) => {
            if (!Prefab) {} else {
              ...
              if (that.RoundEmenyConfig[currentRound - 1][1] > 0) {
                that.schedule(function () {
                  let node = instantiate(Prefab); // node.getChildByName("Emeny2_Pre").setScale(-1,1,1)
          ...
          resources.load("perfabs/KongPerfabs", Prefab, (err, Prefab) => {
            if (!Prefab) {} else {
              console.log("数量为", that.RoundEmenyConfig[currentRound - 1][2]); // for(let i=0;i<that.RoundEmenyConfig[currentRound-1][2];i++){
              //     that.schedule(function(){
              //         let node = instantiate(Prefab)
              //         // node.getChildByName("Emeny2_Pre").setScale(-1,1,1)
              //         node.setScale(-1,1,1);
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "_audioSource", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "clip", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=276e536a20869dd16276ee2cf796887fe06a3c9d.js.map