System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, error, resources, Prefab, instantiate, Layers, find, Label, diji, ShenMuManeger, GlobalLivingClass, SanShePao, ZhuiZongDan, GuangZiJian, FengYiJun, EmenyNormal, EmenyQuickAttack, SHENMU, Bing, Kong, _dec, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, combatConfigManeger;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      diji = _unresolved_2.diji;
    }, function (_unresolved_3) {
      ShenMuManeger = _unresolved_3.ShenMuManeger;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        ...
        start() {
          ...
          this.roundTime = 1;
          this.InitialRoundEmenyConfig(); // let that = this;
        ...
        update(deltaTime) {
          ...
          if (!this.nextFLag && !this.endGameFlag) {
            this.schedule(callback, 10 * deltaTime);
          } else {
        ...
        endGame() {
          ...
          for (let i = 0; i < nodeList.length; i++) {
            if (nodeList[i].isValid) {
              nodeList[i].getChildByName("Emeny_Pre").getComponent(_crd && diji === void 0 ? (_reportPossibleCrUseOfdiji({
                error: Error()
              }), diji) : diji).endGameFlag = true;
            }
          }
        }
        ...
        againRound() {
          this.cleanCombat();
          this.endGameFlag = false; // find("Canvas/ShenMu").getChildByName("shenmu").getComponent(ShenMuManeger).refresh();
      ...
      FengYiJun = class FengYiJun extends GlobalLivingClass {
        constructor() {
          super(180, 0.1, 80, 100, 0.05, 1, 5, 0.05);
        } //升级系统;
...
//# sourceMappingURL=2733f869f03c2b72d0a6e16430fa431608a6abe6.js.map