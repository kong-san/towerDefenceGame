    ...
    execute: function () {
      ...
      _export("ShenMuManeger", ShenMuManeger = (_dec = ccclass('ShenMuManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        initialShenMu() {
          ...
          this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * 0.05; // let that = this;
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.ShenMuLivSysMag.livingValue - 80 <= 0) {
              ...
              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * (this.ShenMuLivSysMag.livingValue / 1000);
            }
          }
          ...
          if (Collider.node.name == "Emeny2_Pre") {
            ...
            if (this.ShenMuLivSysMag.livingValue - 180 <= 0) {
              this.node.parent.destroy();
            } else {
              this.ShenMuLivSysMag.livingValue -= 180; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=05df1b677100d72819c0ee65d588cbb5fd785018.js.map