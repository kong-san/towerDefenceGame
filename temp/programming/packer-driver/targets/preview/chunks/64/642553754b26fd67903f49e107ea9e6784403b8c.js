System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, ProgressBar, audioBeginController, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, loadManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'resources', 'Scene', 'director', 'AudioSource', 'find', 'Canvas', 'ProgressBar']);
      ...
      _export("loadManeger", loadManeger = (_dec = ccclass('loadManeger'), _dec2 = property(_crd && audioBeginController === void 0 ? (_reportPossibleCrUseOfaudioBeginController({
        ...
        update(deltaTime) {
          if (this.node.name == 'beginbox') {
            ...
            this.schedule(function () {
              ...
              if (x > 400) {
                ...
                x = x + 80 * deltaTime;
                that.node.setPosition(x, y, 0); // that.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress += 0.1
              } else {
          ...
          if (this.node.name == 'ProgressBar') {
            ...
            this.schedule(function () {
              _that.node.getComponent(ProgressBar).progress += 0.1 * deltaTime;
            }, 0.8);
          }
        }
...
//# sourceMappingURL=642553754b26fd67903f49e107ea9e6784403b8c.js.map