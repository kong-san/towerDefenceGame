  ...
  return {
    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec(_class = class diji extends Component {
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            if (this.targetArray.length > 0) {
              var targetPos = this.targetArray[1];
              var angle = this.getAngle(bulletNode.position, targetPos);
        ...
        getAngle(start, end) {
          var dx = start.x - (end.x + 800);
          var dy = start.y - (end.y + 450);
...
//# sourceMappingURL=7cf53bd8c91a56bcafa3f1ad3831e8f66eb438a8.js.map