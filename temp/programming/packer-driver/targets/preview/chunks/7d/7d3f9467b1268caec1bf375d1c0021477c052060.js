    ...
    execute: function () {
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node); // node.getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name;
...
//# sourceMappingURL=7d3f9467b1268caec1bf375d1c0021477c052060.js.map