System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, PhysicsSystem2D, EPhysics2DDrawFlags, instantiate, resources, Prefab, Layers, Vec3, NodePool, Vec2, BulletPerManeger, dijiTargetManeger, _dec, _class, _crd, ccclass, property, diji;
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec(_class = class diji extends Component {
        ...
        start() {
          ...
          this.schedule(function () {
            ...
            if (this.hasEmeny) {
              this.targetArray = this.node.getComponent(_crd && dijiTargetManeger === void 0 ? (_reportPossibleCrUseOfdijiTargetManeger({
                error: Error()
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            var angle = this.getAngle(bulletNode.position, new Vec3(0, 0, 0));
            _x = _x + 500 * Math.cos(angle) * deltaTime;
            _y = _y + 500 * Math.sin(angle) * deltaTime; // let distanceX = this.bulletArray[0].x - x;
...
//# sourceMappingURL=056425fea0ab0de580a569395b977e89d14ea6f9.js.map