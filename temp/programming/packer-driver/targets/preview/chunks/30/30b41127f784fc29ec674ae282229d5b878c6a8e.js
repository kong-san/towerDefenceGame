        ...
        attack() {
          ...
          this.schedule(() => {
            ...
            if (that.currentTarget.length) {
              ...
              if (currentTargetNode.isValid) {
                var componentName = that.whichComponent(currentTargetNode.name);
                console.log("敌战机锁定的我方目标是", currentTargetNode.getComponent(componentName));
                currentTargetNode.getComponent(componentName).underAttack(that.HarmValue);
              }
            }
          }, 5);
        }
...
//# sourceMappingURL=30b41127f784fc29ec674ae282229d5b878c6a8e.js.map