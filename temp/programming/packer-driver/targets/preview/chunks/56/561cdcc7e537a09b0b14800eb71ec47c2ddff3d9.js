    ...
    execute: function () {
      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec(_class = class pao extends Component {
        start() {
          ...
          }, this); //   this.node.on(Node.EventType.TOUCH_MOVE,(event)=>{
          //     // console.log('正在拖动')
...
//# sourceMappingURL=561cdcc7e537a09b0b14800eb71ec47c2ddff3d9.js.map