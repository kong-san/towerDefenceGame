    ...
    execute: function () {
      ...
      _export("dijiTargetManeger", dijiTargetManeger = (_dec = ccclass('dijiTargetManeger'), _dec(_class = (_class2 = class dijiTargetManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.hasEmeny = true;
          var targetPosition = otherCollider.node.getWorldPosition(otherCollider.node.position); // this.emenyArray.push(targetPosition);
...
//# sourceMappingURL=c0c4ab66474999c4f826f95cc2785a7f91bed47a.js.map