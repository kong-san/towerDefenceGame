System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'resources', 'Sprite', 'SpriteFrame', 'Layers', 'find', 'Label', 'Vec3']);
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
          ...
          if (toolType == this.currentType) {
            ...
            if (this.currentType == 0) {
              ...
              resources.load('wenzikuang/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                var nameLabel = new Node("nameLabel");
                nameLabel.addComponent(Label);
                nameLabel.getComponent(Label).string = "名称";
                var describeLabel = new Node("describeLabel");
                describeLabel.addComponent(Label);
                node.addChild(nameLabel);
                node.addChild(describeLabel);
                node.setScale(0.7, 0.7, 1); // node.setPosition(0,-50,0)
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印"); // node.getChildByName("nameLabel").getComponent(Label).string = this.SanShePaoInfo.name;
...
//# sourceMappingURL=d9a0ee937651f6f8f95c20eed28fbf72871fe065.js.map