      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        nodeTouchCancel(event) {
          ...
          if (!step) {
            ...
            nodePao.parent = nodePao.parent.getChildByName("left").getChildByName(parentName);
            nodePao.setPosition(100, 100, 0); // console.log(nodePao.parent);
          }
        }
...
//# sourceMappingURL=f430e34b2b78d657b8e3a9cd2849df09ce734602.js.map