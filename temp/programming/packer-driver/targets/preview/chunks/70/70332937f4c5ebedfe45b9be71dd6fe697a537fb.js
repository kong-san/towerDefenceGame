    ...
    execute: function () {
      ...
      _export("dijiTargetManeger", dijiTargetManeger = (_dec = ccclass('dijiTargetManeger'), _dec(_class = (_class2 = class dijiTargetManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (otherCollider.node.name == "") this.emenyArray.push(otherCollider.node); // console.log("我是目标检测器，我发现目标数量：",this.emenyArray.length)
...
//# sourceMappingURL=70332937f4c5ebedfe45b9be71dd6fe697a537fb.js.map