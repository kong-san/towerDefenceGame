System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, instantiate, _dec, _class, _crd, ccclass, property, PaoPerManeger;
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec(_class = class PaoPerManeger extends Component {
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            var _node = this.bulletArray[i];
            var y = _node.position.y;
            var x = _node.position.x;
            x = x - 500 * deltaTime;
            y = y + 500 * deltaTime;

            _node.setPosition(x, y, 0); //TODO:出屏幕后销毁
        ...
        createBullet() {
          ...
          var that = this;
          resources.load("perfabs/Bullet_Pre", (err, Prefab) => {
            if (!Prefab) {
              console.log('子弹预制体为空');
            } else {
              console.log('预制体制作完成');
              ...
              if (!_node2) {
                ...
                console.log(_node2); // node.layer = Layers.Enum.UI_2D;
              }
            }
          });
          node.parent = this.node;
          node.setPosition(100, 100, 0); // resources.load('zidan1/spriteFrame',SpriteFrame,(_err,sproteFarme)=>{
...
//# sourceMappingURL=3163676ed42962057acb1277d6626e1a719ad71b.js.map