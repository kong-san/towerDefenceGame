        ...
        attack(dt) {
          ...
          this.schedule(function () {
            ...
            if (that.currentTarget.length) {
              ...
              var componentName = that.whichComponent(currentTargetNode.name); // currentTargetNode.getComponent(componentName).underAttack(that.HarmValue);
            }
          }, 5 * dt);
        }
...
//# sourceMappingURL=bb1a816e5854560e1e8451a1f214ccc2404e98db.js.map