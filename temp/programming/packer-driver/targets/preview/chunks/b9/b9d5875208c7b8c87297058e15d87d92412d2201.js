System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PhysicsSystem2D', 'EPhysics2DDrawFlags', 'Collider2D', 'Contact2DType', 'IPhysics2DContact', 'BoxCollider2D', 'director', 'Sprite', 'Color', 'resources', 'SpriteFrame', 'Layers', 'find', 'Prefab', 'instantiate', 'Vec2', 'ProgressBar', 'NodePool', 'Label', 'Vec3', 'AudioClip']);
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        error: Error()
      }), audioBeginController) : audioBeginController), _dec(_class = (_class2 = class PaoPerManeger extends Component {
        constructor() {
          super(...arguments);
          this.bulletArray = [];
          this.hasEmeny = true;
        ...
        update(deltaTime) {// console.log(this.bulletArray.length);
          ...
          // if(this.currenTarget.isValid && this.currenTarget.name!="newNode"){
          //     // console.log("目标敌机是",that.currenTarget)
          //     this.angle = this.getAngle(this.node.worldPosition,this.currenTarget.worldPosition)
          // }
...
//# sourceMappingURL=b9d5875208c7b8c87297058e15d87d92412d2201.js.map