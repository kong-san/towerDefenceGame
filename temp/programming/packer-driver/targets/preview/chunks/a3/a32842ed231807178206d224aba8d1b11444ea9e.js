    ...
    execute: function () {
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印"); // console.log(node.getChildByName("nodeLabel"))
            // node.getChildByName("nodeLabel").getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name;
...
//# sourceMappingURL=a32842ed231807178206d224aba8d1b11444ea9e.js.map