      ...
      _export("updateComponent", updateComponent = (_dec = ccclass('updateComponent'), _dec2 = property(Node), _dec(_class = (_class2 = class updateComponent extends Component {
        ...
        updateNode() {
          ...
          if (nodeAlias.isValid) {
            if (nodeAlias.name = "") find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
              error: Error()
...
//# sourceMappingURL=108c6285b439c8c517dc0f61cf5b9237f5daf488.js.map