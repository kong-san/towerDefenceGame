System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, Prefab, instantiate, Vec2, _dec, _class, _crd, ccclass, property, PaoPerManeger;
          ...
          resources.load("perfabs/Bullet_Pre", Prefab, (err, Prefab) => {
            if (!Prefab) {
              ...
              if (!node) {
                ...
                var y = that.node.position.x;
                var shit = pos.set(x, y);
                x = shit.x - 800;
                y = shit.y - 450;
                console.log(x, y);
...
//# sourceMappingURL=a9160afc223782014cefbf1372df3393b0d37d4b.js.map