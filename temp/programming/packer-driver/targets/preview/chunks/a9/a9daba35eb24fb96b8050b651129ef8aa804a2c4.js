    ...
    execute: function () {
      ...
      _export("BulletPerManeger", BulletPerManeger = (_dec = ccclass('BulletPerManeger'), _dec(_class = (_class2 = class BulletPerManeger extends Component {
        ...
        update(deltaTime) {
          ...
          var y = this.node.position.y; //子弹的飞行和角度模式选择
        ...
        DanBullet(deltaTime) {
          ...
          var y1 = this.node.position.y; //关键是：currenTarget.isValid，获取塔防目前锁定的currentTarget是否有效，有效则进行攻击
...
//# sourceMappingURL=a9daba35eb24fb96b8050b651129ef8aa804a2c4.js.map