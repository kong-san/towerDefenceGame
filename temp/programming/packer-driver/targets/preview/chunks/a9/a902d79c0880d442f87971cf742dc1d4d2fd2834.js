System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, error, resources, Prefab, instantiate, Layers, find, GlobalLivingClass, SanShePao, ZhuiZongDan, GuangZiJian, EmenyNormal, EmenyQuickAttack, _dec, _class, _class2, _descriptor, _crd, ccclass, property, combatConfigManeger;
    ...
    execute: function () {
      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        ...
        createSingleRoundEmeny(currentRound) {
          var that = this; // for(let i=0;i<this.RoundEmenyConfig[currentRound-1][0];i++){
...
//# sourceMappingURL=a902d79c0880d442f87971cf742dc1d4d2fd2834.js.map