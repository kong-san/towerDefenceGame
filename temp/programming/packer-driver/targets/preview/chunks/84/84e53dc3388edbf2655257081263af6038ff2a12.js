System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, Vec2, BoxCollider2D, Collider2D, Contact2DType, toolPyManeger, ToolStateManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, pao;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'SpriteFrame', 'resources', 'director', 'Layers', 'Scene', 'UITransform', 'Vec3', 'Vec2', 'BoxCollider2D', 'Collider', 'Collider2D', 'Contact2DType']);
      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        nodeTouchCancel(event) {
          ...
          nodePao.getComponent(Collider2D).on(Contact2DType.BEGIN_CONTACT, () => {
...
//# sourceMappingURL=84e53dc3388edbf2655257081263af6038ff2a12.js.map