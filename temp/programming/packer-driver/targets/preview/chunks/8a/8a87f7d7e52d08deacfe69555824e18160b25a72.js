      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            var _x = bulletNode.position.x;

            if (this.targetArray.length > 0) {
              _x = _x + this.DijiLivSysMag.attackSpeed * deltaTime;
            } else {
              if (i % 3 == 1) {
                _x = _x + this.DijiLivSysMag.attackSpeed * Math.cos(60 * Math.PI / 180) * deltaTime;
                _y = _y - this.DijiLivSysMag.attackSpeed * Math.sin(60 * Math.PI / 180) * deltaTime;
              } else if (i % 3 == 2) {
                _x = _x + this.DijiLivSysMag.attackSpeed * Math.cos(70 * Math.PI / 180) * deltaTime;
                _y = _y - this.DijiLivSysMag.attackSpeed * Math.sin(70 * Math.PI / 180) * deltaTime;
              } else {
                _x = _x + this.DijiLivSysMag.attackSpeed * Math.cos(80 * Math.PI / 180) * deltaTime;
                _y = _y - this.DijiLivSysMag.attackSpeed * Math.sin(80 * Math.PI / 180) * deltaTime;
              }
            }

            bulletNode.setPosition(_x, _y, 0); // }
            // TODO:出屏幕后销毁
          }
        }
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "PaoBulletPer") {
            if (this.DijiLivSysMag.livingValue - 40 <= 0) {
              this.node.parent.destroy();
            } else {
              this.DijiLivSysMag.livingValue -= 40; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
          ...
          if (Collider.node.name == "FengyiBulletPer") {
            if (this.DijiLivSysMag.livingValue - 30 <= 0) {
              this.node.parent.destroy();
            } else {
              this.DijiLivSysMag.livingValue -= 30; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=8a87f7d7e52d08deacfe69555824e18160b25a72.js.map