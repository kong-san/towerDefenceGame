        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.SanShePaoLivSysMag.livingValue - 10 < 0) {
              ...
              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = this.SanShePaoLivSysMag.livingValue / 100;
            }
          }
        } //生成子弹
...
//# sourceMappingURL=4be82ef57f42f44a3fb5f03c14630cf93be19826.js.map