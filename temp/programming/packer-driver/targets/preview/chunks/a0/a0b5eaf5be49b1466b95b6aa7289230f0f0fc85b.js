      ...
      _export("updateComponent", updateComponent = (_dec = ccclass('updateComponent'), _dec2 = property(Node), _dec(_class = (_class2 = class updateComponent extends Component {
        ...
        updateNode(node) {
          ...
          if (nodeAlias.isValid) {
            ...
            var level = node.getComponent(_crd && PaoPerManeger === void 0 ? (_reportPossibleCrUseOfPaoPerManeger({
              error: Error()
...
//# sourceMappingURL=a0b5eaf5be49b1466b95b6aa7289230f0f0fc85b.js.map