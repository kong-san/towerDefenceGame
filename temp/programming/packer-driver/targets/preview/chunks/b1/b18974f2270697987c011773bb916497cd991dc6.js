          ...
          this.schedule(() => {
            ...
            if (that.currentTarget.length) {
              ...
              for (var i = 0; i < that.currentTarget.length; i++) {
                //用链表来可能合适;
                if (that.currentTargetNode.name == "default" || !that.currentTargetNode.isValid || !that.currentTargetNode) {
...
//# sourceMappingURL=b18974f2270697987c011773bb916497cd991dc6.js.map