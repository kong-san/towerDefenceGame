    ...
    execute: function () {
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node.getChildByPath("nodeLabel")); // node.getChildByName("nodeLabel").getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name;
...
//# sourceMappingURL=186a8d10da27173f79d5828e3894f4706993fe68.js.map