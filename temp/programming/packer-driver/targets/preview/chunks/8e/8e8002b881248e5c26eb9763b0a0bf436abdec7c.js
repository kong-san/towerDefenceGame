    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          var x = node.position.x; // this.endGameFlag = find("Canvas/GlobalRoundcontrol").getComponent(combatConfigManeger).endGameFlag;
...
//# sourceMappingURL=8e8002b881248e5c26eb9763b0a0bf436abdec7c.js.map