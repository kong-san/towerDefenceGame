      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node);
            node.getChildByName("name").getChildByName("infoLabel").getComponent(Label).string = this.SanShePaoInfo.name; // node.getChildByName("describeLabel").getComponent(Label).string = this.SanShePaoInfo.describe;
          }
...
//# sourceMappingURL=8e3557d5b93fbd67bbdb4b0ce97903d8b93ce8b3.js.map