System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, error, Prefab, instantiate, Layers, find, GlobalLivingClass, SanShePao, ZhuiZongDan, GuangZiJian, EmenyNormal, EmenyQuickAttack, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, combatConfigManeger;
    ...
    execute: function () {
      ...
      _export("combatConfigManeger", combatConfigManeger = (_dec = ccclass('combatConfigManeger'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec(_class = (_class2 = class combatConfigManeger extends Component {
        ...
        createSingleRoundEmeny(currentRound) {
          ...
          for (var i = 0; i < this.RoundEmenyConfig[currentRound - 1][0]; i++) {
            var node = instantiate(this.EmenyNormal);
            node.layer = Layers.Enum.UI_2D;
            node.setPosition(0, 0, 0);
            node.parent = find("Canvas/EmenyBox");
          }

          for (var _i = 0; _i < this.RoundEmenyConfig[currentRound - 1][1]; _i++) {
            var _node = instantiate(this.EmenyQuickAttack);

            _node.layer = Layers.Enum.UI_2D;

            _node.setPosition(0, 0, 0);

            _node.parent = find("Canvas/EmenyBox");
...
//# sourceMappingURL=6d0fbea094e4d72e080366a42d2014c76ecaf2b9.js.map