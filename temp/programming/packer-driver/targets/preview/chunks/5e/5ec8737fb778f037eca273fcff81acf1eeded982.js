System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, find, Prefab, instantiate, ProgressBar, NodePool, Label, BulletPerManeger, combatConfigManeger, livingSystemManeger, targetManeger, updateComponent, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PaoPerManeger;
    ...
    execute: function () {
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        start() {
          ...
          console.log("炮的父节点", this.node.parent);
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            var x = bulletNode.position.x; // if(this.node.parent.parent.name == "left"){
            //     x = x - speed * deltaTime;
            //     y = y + speed * deltaTime;  
            // }

            bulletNode.setPosition(x, y, 0); // if(this.node.parent.parent.name == "right")
            //     x = x + speed * deltaTime;
            //     y = y + speed * deltaTime;
        ...
        refreshData() {
          ...
          var subValue = LivingValue - this.SanShePaoLivSysMag.livingValue;
        ...
        underFire(Collider) {
          ...
          var defendValue = this.SanShePaoLivSysMag.defendValue;
        ...
        underAttack(harmedValue) {
          ...
          if (this.currentLivingValue - harmedValue * this.SanShePaoLivSysMag.livingValue * (1 - defendValue) <= 0) {
            ...
            this.currentLivingValue -= harmedValue * this.SanShePaoLivSysMag.livingValue * (1 - defendValue); // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=5ec8737fb778f037eca273fcff81acf1eeded982.js.map