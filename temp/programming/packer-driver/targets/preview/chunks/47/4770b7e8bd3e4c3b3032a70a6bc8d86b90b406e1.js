      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec(_class = class diji extends Component {
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            var _x = bulletNode.position.x; // if(this.targetArray.length>0){
            ...
            if (i % 3 == 1) {
              _x = _x + 500 * Math.cos(30 * Math.PI / 180) * deltaTime;
              _y = _y - 500 * Math.sin(30 * Math.PI / 180) * deltaTime;
            } else if (i % 3 == 2) {
              _x = _x + 500 * Math.cos(45 * Math.PI / 180) * deltaTime;
              _y = _y - 500 * Math.sin(45 * Math.PI / 180) * deltaTime;
            } else {
...
//# sourceMappingURL=4770b7e8bd3e4c3b3032a70a6bc8d86b90b406e1.js.map