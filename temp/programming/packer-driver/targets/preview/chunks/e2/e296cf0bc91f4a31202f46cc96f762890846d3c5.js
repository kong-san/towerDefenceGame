System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, find, Prefab, instantiate, ProgressBar, NodePool, Label, BulletPerManeger, combatConfigManeger, livingSystemManeger, targetManeger, audioBeginController, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, FengyiPerManeger;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      audioBeginController = _unresolved_6.audioBeginController;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PhysicsSystem2D', 'EPhysics2DDrawFlags', 'Collider2D', 'Contact2DType', 'IPhysics2DContact', 'resources', 'Layers', 'find', 'Prefab', 'instantiate', 'ProgressBar', 'NodePool', 'Label']);
      ...
      _export("FengyiPerManeger", FengyiPerManeger = (_dec = ccclass('FengyiPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        error: Error()
      }), audioBeginController) : audioBeginController), _dec(_class = (_class2 = class FengyiPerManeger extends Component {
        constructor() {
          super(...arguments);
          this.bulletArray = [];
          this.hasEmeny = true;
        ...
        update(deltaTime) {
          ...
          node.setPosition(x, y, 0); // console.log(this.bulletArray.length);
          // //获取攻击速度
            ...
            if (!Prefab) {} else {
              ...
              if (!node) {} else {
                ...
                node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                  error: Error()
                }), BulletPerManeger) : BulletPerManeger).speed = that.FengyiLivSysMag.attackSpeed; //种类

                node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                  error: Error()
                }), BulletPerManeger) : BulletPerManeger).bulletType = 4; //角度

                node.setScale(1.2, 1.2, 1.2); // node.getComponent(BulletPerManeger).angle = that.angle;
...
//# sourceMappingURL=e296cf0bc91f4a31202f46cc96f762890846d3c5.js.map