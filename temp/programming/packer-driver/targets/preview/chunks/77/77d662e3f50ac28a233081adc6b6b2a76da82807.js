System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, Vec2, BoxCollider2D, locationPyManeger, _dec, _class, _crd, ccclass, property, pao;

  function _reportPossibleCrUseOflocationPyManeger(extras) {
    _reporterNs.report("locationPyManeger", "./locationPyManeger", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      locationPyManeger = _unresolved_2.locationPyManeger;
    }],
    execute: function () {
      _crd = true;
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                node.getComponent(BoxCollider2D).group = 2;
                console.log(node.getComponent(BoxCollider2D));
                node.addComponent(_crd && locationPyManeger === void 0 ? (_reportPossibleCrUseOflocationPyManeger({
                  error: Error()
                }), locationPyManeger) : locationPyManeger); // node.setPosition(event.touch.point.x)
                // console.log(node);
...
//# sourceMappingURL=77d662e3f50ac28a233081adc6b6b2a76da82807.js.map