      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        nodeTouchCancel(event) {
          ...
          if (!step) {
            ...
            console.log(nodePao.parent.getChildByName("left").getChildByName(parentName)); // nodePao.parent = nodePao.parent.getChildByName("left").getChildByName(parentName);
...
//# sourceMappingURL=3ae5804a3f9fcb0e183193f36e984a2f53607664.js.map