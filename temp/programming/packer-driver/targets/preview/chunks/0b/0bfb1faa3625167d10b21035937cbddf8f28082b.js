System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, Vec2, BoxCollider2D, Collider2D, PaoState, toolPyManeger, ToolStateManeger, workPyManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, pao;
  ...
  function _reportPossibleCrUseOfworkPyManeger(extras) {
    _reporterNs.report("workPyManeger", "./workPyManeger", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      workPyManeger = _unresolved_5.workPyManeger;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        nodeTouchCancel(event) {
          console.log('已取消触摸事件');
          var nodePao = this.node.parent.parent.parent.getChildByName('pao1');
          console.log(nodePao.getComponent(Collider2D));
          var step = nodePao.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
            error: Error()
          ...
          if (!step) {
            ...
            // nodePao.parent = find()
            var parentName = nodePao.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
              error: Error()
        ...
        NewPao() {
          ...
          resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
            ...
            node.addComponent(BoxCollider2D);
            node.getComponent(BoxCollider2D).group = 4; // console.log(node.getComponent(BoxCollider2D))

            node.addComponent(_crd && workPyManeger === void 0 ? (_reportPossibleCrUseOfworkPyManeger({
              error: Error()
            }), workPyManeger) : workPyManeger); // node.addComponent(PaoState)
...
//# sourceMappingURL=0bfb1faa3625167d10b21035937cbddf8f28082b.js.map