System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, find, Label, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, updateComponent;
      ...
      _export("updateComponent", updateComponent = (_dec = ccclass('updateComponent'), _dec2 = property(Node), _dec(_class = (_class2 = class updateComponent extends Component {
        ...
        updateNode(node) {
          ...
          if (nodeAlias.isValid) {
            nodeAlias.parent.getChildByName("level").getComponent(Label).string = "L2";
          }
        }
...
//# sourceMappingURL=434841a9f6882686f799f7c4a20b99834f836725.js.map