      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node);
            node.getChildByName("name").getChildByName().getComponent(Label).string = this.SanShePaoInfo.name; // node.getChildByName("describeLabel").getComponent(Label).string = this.SanShePaoInfo.describe;
          }
...
//# sourceMappingURL=43304a772a4d4ca4aa0acdf654cbba16c8898603.js.map