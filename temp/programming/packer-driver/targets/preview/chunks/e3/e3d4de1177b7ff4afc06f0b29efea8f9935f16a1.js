        ...
        update(deltaTime) {
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              var pos = new Vec3(event.getLocationX(), event.getLocationY(), 0); // let pos = new Vec3(event.touch._point['x'],event.touch._point['y'],0);
              //转换为UI作表
...
//# sourceMappingURL=e3d4de1177b7ff4afc06f0b29efea8f9935f16a1.js.map