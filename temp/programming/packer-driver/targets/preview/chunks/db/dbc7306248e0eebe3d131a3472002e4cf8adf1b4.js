    ...
    execute: function () {
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.hasEmeny = true; // console.log('I am PAO');
          //64是tool_target
          //16是diji_self
        ...
        initialSanshePao() {
          this.SanShePaoLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(100, 10, 10, 1, 300); // let that = this;
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.SanShePaoLivSysMag.livingValue - 80 <= 0) {
              ...
              this.SanShePaoLivSysMag.livingValue -= 80; // console.log("生命值为：",this.SanShePaoLivSysMag.livingValue)
...
//# sourceMappingURL=dbc7306248e0eebe3d131a3472002e4cf8adf1b4.js.map