      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        start() {
          ...
          this.schedule(function () {
            this.hasEmeny = this.node.parent.getComponent(_crd && targetManeger === void 0 ? (_reportPossibleCrUseOftargetManeger({
              error: Error()
            }), targetManeger) : targetManeger).hasEmeny;

            if (this.hasEmeny) {
              this.targetArray = this.node.parent.getComponent(_crd && targetManeger === void 0 ? (_reportPossibleCrUseOftargetManeger({
                error: Error()
              ...
              if (!flag) {
                this.hasEmeny = false;
                this.node.parent.getComponent(_crd && targetManeger === void 0 ? (_reportPossibleCrUseOftargetManeger({
                  error: Error()
...
//# sourceMappingURL=f52b6db697e1d06d1aea9ee95bd5ee837b813dda.js.map