    ...
    execute: function () {
      ...
      _export("dijiTargetManeger", dijiTargetManeger = (_dec = ccclass('dijiTargetManeger'), _dec(_class = (_class2 = class dijiTargetManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.hasEmeny = true;
          var x = otherCollider.node.getWorldPosition(otherCollider.node.position); // let y = otherCollider.node.position.y;
...
//# sourceMappingURL=a19e43155e518a77c6f533f3fc707fb3fe42a13e.js.map