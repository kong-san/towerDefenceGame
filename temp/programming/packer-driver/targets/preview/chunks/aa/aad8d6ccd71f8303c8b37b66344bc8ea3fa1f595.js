System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, find, Prefab, instantiate, ProgressBar, NodePool, Label, combatConfigManeger, livingSystemManeger, targetManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, FengyiPerManeger;
    ...
    execute: function () {
      ...
      _export("FengyiPerManeger", FengyiPerManeger = (_dec = ccclass('FengyiPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          y = y + this.where * 100 * deltaTime; // console.log(this.bulletArray.length);
          // //获取攻击速度
...
//# sourceMappingURL=aad8d6ccd71f8303c8b37b66344bc8ea3fa1f595.js.map