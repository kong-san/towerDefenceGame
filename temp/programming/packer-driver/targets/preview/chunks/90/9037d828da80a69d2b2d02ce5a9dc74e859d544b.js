        ...
        update(deltaTime) {
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              var pos = new Vec3(event.getLocationX(), event.getLocationY(), event.getLocationZ()); // let pos = new Vec3(event.touch._point['x'],event.touch._point['y'],0);
              //转换为UI作表
...
//# sourceMappingURL=9037d828da80a69d2b2d02ce5a9dc74e859d544b.js.map