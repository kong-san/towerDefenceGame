System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, Vec2, BoxCollider2D, Collider2D, PaoState, test, toolPyManeger, ToolStateManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, pao;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      test = _unresolved_3.test;
    }, function (_unresolved_4) {
      toolPyManeger = _unresolved_4.toolPyManeger;
    }, function (_unresolved_5) {
      ToolStateManeger = _unresolved_5.ToolStateManeger;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        NewPao() {
          ...
          resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
            ...
            node.addComponent(_crd && test === void 0 ? (_reportPossibleCrUseOftest({
              error: Error()
            }), test) : test);
            console.log('炮开始工作');
          });
...
//# sourceMappingURL=26a18cd1eb53b1a0de5af108316854e1c0253b65.js.map