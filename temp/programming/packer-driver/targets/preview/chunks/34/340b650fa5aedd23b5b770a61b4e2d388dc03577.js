System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, resources, SpriteFrame, Layers, find, Vec2, BoxCollider2D, Collider2D, infoManeger, toolPyManeger, _dec, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, selectToolManeger;
      ...
      _export("selectToolManeger", selectToolManeger = (_dec = ccclass('selectToolManeger'), _dec(_class = (_class2 = class selectToolManeger extends Component {
        ...
        SelectToolAndMove(event) {
          if (find("Canvas/selectToolBox").getChildByName(this.toolname)) {
            ...
            var currentNode = find("Canvas/selectToolBox").getChildByName(this.toolname);
            var pos = new Vec2();
            ...
            var node = new Node(this.toolname);
            node.addComponent(Sprite);
            var spriteFramePath = 'pao/spriteFrame';
            ...
            resources.load(spriteFramePath, SpriteFrame, (_err, spriteFrame) => {
              ...
              node.addComponent(BoxCollider2D); // console.log(node.getComponent(BoxCollider2D))
        ...
        SelectToolAndCancel(event) {
          console.log('已取消触摸事件');
          var selectNode = find("Canvas/selectToolBox").getChildByName(this.toolname);
          ...
          var parentName = selectNode.getComponent(_crd && toolPyManeger === void 0 ? (_reportPossibleCrUseOftoolPyManeger({
            error: Error()
          ...
          if (!(step == 1)) {
            ...
            selectNode.getComponent(_crd && toolPyManeger === void 0 ? (_reportPossibleCrUseOftoolPyManeger({
              error: Error()
            }), toolPyManeger) : toolPyManeger).ToolStateManeger.step = 2; // selectNode.destroy();
          }
        }
...
//# sourceMappingURL=340b650fa5aedd23b5b770a61b4e2d388dc03577.js.map