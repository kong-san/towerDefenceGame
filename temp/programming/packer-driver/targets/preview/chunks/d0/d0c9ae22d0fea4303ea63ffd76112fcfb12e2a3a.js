      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          if (x > 500) {//敌军飞机不超过神木；
            ...
            x = x + 40 * deltaTime; // y = y - 10 * deltaTime;
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            if (this.targetArray.length > 0) {
              ...
              if (i % 3 == 1) {
                _x = _x + 500 * Math.cos(60 * Math.PI / 180) * deltaTime;
                _y = _y - 500 * Math.sin(60 * Math.PI / 180) * deltaTime;
              } else if (i % 3 == 2) {
                _x = _x + 500 * Math.cos(70 * Math.PI / 180) * deltaTime;
                _y = _y - 500 * Math.sin(70 * Math.PI / 180) * deltaTime;
              } else {
                _x = _x + 500 * Math.cos(80 * Math.PI / 180) * deltaTime;
                _y = _y - 500 * Math.sin(80 * Math.PI / 180) * deltaTime;
              }
            }
        ...
        initialDiji() {
          this.DijiLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(100, 10, 10, 11, 100); // let that = this;
...
//# sourceMappingURL=d0c9ae22d0fea4303ea63ffd76112fcfb12e2a3a.js.map