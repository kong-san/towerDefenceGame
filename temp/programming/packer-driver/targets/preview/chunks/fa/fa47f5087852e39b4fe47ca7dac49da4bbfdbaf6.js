System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, resources, Sprite, SpriteFrame, Layers, Prefab, instantiate, _dec, _class, _class2, _descriptor, _crd, ccclass, property, infoManeger;
    ...
    execute: function () {
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node.getChildByPath("nodeLabel").getChildByName("name")); // node.getChildByName("nodeLabel").getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name;
...
//# sourceMappingURL=fa47f5087852e39b4fe47ca7dac49da4bbfdbaf6.js.map