    ...
    execute: function () {
      ...
      _export("BulletPerManeger", BulletPerManeger = (_dec = ccclass('BulletPerManeger'), _dec(_class = class BulletPerManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          // console.log('Bullet and Emeny onBeginContact');
          console.log("i am bullet , my target is", otherCollider);
        }

        onEndContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体结束接触时被调用一次
          console.log('Bullet and Emeny Work onEndContact');
        }
...
//# sourceMappingURL=1d9c0e154d8d894822b333bbec1c1dacd3e18b28.js.map