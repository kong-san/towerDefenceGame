System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, find, Prefab, instantiate, ProgressBar, NodePool, BulletPerManeger, combatConfigManeger, livingSystemManeger, targetManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GuangziPerManeger;
      ...
      _export("GuangziPerManeger", GuangziPerManeger = (_dec = ccclass('GuangziPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            var x = bulletNode.position.x; //left
...
//# sourceMappingURL=1d76447f9543b5e0bc1edd056aa6ef4e93c18617.js.map