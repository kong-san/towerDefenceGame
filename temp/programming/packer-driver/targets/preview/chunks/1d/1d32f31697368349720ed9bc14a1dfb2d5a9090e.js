System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, PhysicsSystem2D, EPhysics2DDrawFlags, instantiate, resources, Prefab, Layers, NodePool, BulletPerManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, diji;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(NodePool), _dec(_class = (_class2 = class diji extends Component {
        constructor() {
          super(...arguments);
          this.bulletArray = [];
          this.hasEmeny = true;
          ...
          _initializerDefineProperty(this, "bulletPool", _descriptor, this);
        }
        ...
        start() {
          ...
          this.schedule(function () {// if(that.bulletPool.size()<=0){
            //     console.log("子弹对象使用完毕。")
            //     if(this.hasEmeny){
            //         console.log('createBullet')
            //         that.createBullet();
            //     }
          ...
          resources.load("perfabs/Bullet_Pre", Prefab, (err, Prefab) => {
            if (!Prefab) {
              ...
              if (!node) {
                ...
                that.node.addChild(node); //放入当前数组

                that.bulletArray.push(node); //放入对象池

                that.bulletPool.put(node);
              }
            }
          });
        }

      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "bulletPool", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=1d32f31697368349720ed9bc14a1dfb2d5a9090e.js.map