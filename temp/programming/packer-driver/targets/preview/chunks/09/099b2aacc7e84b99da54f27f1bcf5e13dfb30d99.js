        ...
        update(deltaTime) {
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              var pos = new Vec3(event.getLocationX(), event.getLocationY()); // let pos = new Vec3(event.touch._point['x'],event.touch._point['y'],0);
              //转换为UI作表
...
//# sourceMappingURL=099b2aacc7e84b99da54f27f1bcf5e13dfb30d99.js.map