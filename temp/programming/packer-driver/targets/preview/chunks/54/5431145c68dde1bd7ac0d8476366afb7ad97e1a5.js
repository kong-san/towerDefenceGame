System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, Sprite, Color, _dec, _class, _crd, ccclass, property, workPyManeger;
    ...
    execute: function () {
      ...
      _export("workPyManeger", workPyManeger = (_dec = ccclass('workPyManeger'), _dec(_class = class workPyManeger extends Component {
        ...
        onPostSolve(selfCollider, otherCollider, contact) {
          // 每次处理完碰撞体接触逻辑时被调用
          console.log('onPostSolve'); // selfCollider.node.getComponent(Sprite).color = Color.TRANSPARENT;
        }
...
//# sourceMappingURL=5431145c68dde1bd7ac0d8476366afb7ad97e1a5.js.map