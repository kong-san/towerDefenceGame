System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, find, ProgressBar, livingSystemManeger, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, ShenMuManeger;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShenMuManeger", ShenMuManeger = (_dec = ccclass('ShenMuManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        start() {
          this.initialShenMu();
          this.ShenMuConfig = find("Canvas/GlobalRoundControl"); //注册单个碰撞体的回调函数
...
//# sourceMappingURL=0391a7b233f3a9f4ae3b0f190e074dbe93c4faa5.js.map