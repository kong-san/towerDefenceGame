        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              console.log(event.touch.point.x); // this.node.parent.parent.getChildByName('pao1').destroy();
            } else {
              ...
              resources.load('pao/spriteFrame', SpriteFrame, (_err, spriteFrame) => {
                ...
                console.log(event.touch.point.x);
                console.log('炮创建成功');
...
//# sourceMappingURL=03c4cb6162cff3947b35e0c2273826f21d456e9b.js.map