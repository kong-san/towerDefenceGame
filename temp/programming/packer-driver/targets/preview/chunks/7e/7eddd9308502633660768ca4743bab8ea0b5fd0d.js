System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, Prefab, instantiate, ProgressBar, livingSystemManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PaoPerManeger;
    ...
    execute: function () {
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          // this.hasEmeny = true;
          console.log('I am PAO'); //64是tool_target
          //16是diji_self
        ...
        onEndContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体结束接触时被调用一次
          console.log('PAO onEndContact'); // this.hasEmeny = false;
        }
        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.SanShePaoLivSysMag.livingValue - 10 < 0) {
              this.node.destroy();
            } else {
              this.SanShePaoLivSysMag.livingValue -= 10;
              console.log("生命值为：", this.SanShePaoLivSysMag.livingValue);
              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 1 * this.SanShePaoLivSysMag.livingValue / 100;
            }
          }
        } //生成子弹
...
//# sourceMappingURL=7eddd9308502633660768ca4743bab8ea0b5fd0d.js.map