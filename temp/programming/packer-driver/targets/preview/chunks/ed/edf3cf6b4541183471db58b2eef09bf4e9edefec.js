      ...
      _export("pao", pao = (_dec = ccclass('pao'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        nodeTouchCancel(event) {
          ...
          if (!step) {
            ...
            NewNode.parent = nodePao.parent.getChildByName("left").getChildByName(parentName);
            NewNode.active = true; // nodePao.destroy();
...
//# sourceMappingURL=edf3cf6b4541183471db58b2eef09bf4e9edefec.js.map