System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, SpriteFrame, resources, Layers, UITransform, _dec, _class, _crd, ccclass, property, pao;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'SpriteFrame', 'resources', 'director', 'Layers', 'Scene', 'UITransform']);
        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              var uiTransform = this.node.parent.parent.parent.getComponent(UITransform);
              uiTransform.setAnchorPoint(0, 0);
              var x = event.touch._point['x'];
              var y = event.touch._point['y'];
...
//# sourceMappingURL=72c1e492bf6dc63a91d9cd6f393addf09283be0e.js.map