      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            console.log(node);
            node.getChildByName("infoLabel").getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name; // node.getChildByName("describeLabel").getComponent(Label).string = this.SanShePaoInfo.describe;
          }
...
//# sourceMappingURL=7210dd210465fec82e87a1239ae589d73c23b5e8.js.map