      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            ...
            node.getChildByPath("nodeLabel").getChildByName("describeLabel").getComponent(Label).string = this.SanShePaoInfo.describe;
          }
...
//# sourceMappingURL=586be01b147f09aca8e8c2c0dfead02f951b4962.js.map