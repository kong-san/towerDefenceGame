System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'PhysicsSystem2D', 'EPhysics2DDrawFlags', 'Collider2D', 'Contact2DType', 'IPhysics2DContact', 'resources', 'SpriteFrame', 'Layers', 'find', 'Prefab', 'instantiate', 'Vec2', 'ProgressBar', 'NodePool', 'Vec3', 'Label']);
      ...
      _export("GuangziPerManeger", GuangziPerManeger = (_dec = ccclass('GuangziPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        error: Error()
      }), audioBeginController) : audioBeginController), _dec(_class = (_class2 = class GuangziPerManeger extends Component {
        constructor() {
          super(...arguments);
          this.bulletArray = [];
          this.hasEmeny = true;
        ...
        initialGuangzi() {
          var AttackSpeed = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).GuangZiJian.AttackSpeed;
          var LivingValue = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).GuangZiJian.LivingValue;
          var DefendValue = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).GuangZiJian.DefendValue;
          ...
          var level = find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).GuangZiJian.GradeValue;
          ...
          this.GuangziLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(LivingValue, HarmValue, DefendValue, 3, AttackSpeed);
          this.currentLivingValue = LivingValue; // console.log("散射炮初始化成功")

          find("Canvas/GlobalRoundControl").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
          }), combatConfigManeger) : combatConfigManeger).GuangZiJianList.push(this.node);
        }
        ...
        underFire(Collider) {
          ...
          var defendValue = this.GuangziLivSysMag.defendValue;
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.currentLivingValue - harmedValueEmeny * (1 - defendValue) <= 0) {
              ...
              this.currentLivingValue -= harmedValueEmeny * (1 - defendValue); // console.log("生命值为：",this.GuangZiJianLivSysMag.livingValue)
        ...
        underAttack(harmedValue) {
          ...
          if (this.currentLivingValue - harmedValue * this.GuangziLivSysMag.livingValue * (1 - defendValue) <= 0) {
            ...
            this.currentLivingValue -= harmedValue * this.GuangziLivSysMag.livingValue * (1 - defendValue); // console.log("生命值为：",this.GuangziLivSysMag.livingValue)
        ...
        createBullet() {
          ...
          resources.load("perfabs/GuangZiBulletPer", Prefab, (err, Prefab) => {
            if (!Prefab) {// console.log('子弹/预制体为空')
            } else {
              var _loop = function _loop(i) {
                that.schedule(function () {
                  ...
                  node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                    error: Error()
                  }), BulletPerManeger) : BulletPerManeger).speed = that.GuangziLivSysMag.attackSpeed; //种类

                  node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                    error: Error()
                  }), BulletPerManeger) : BulletPerManeger).bulletType = 3; //角度

                  node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                    error: Error()
                  }), BulletPerManeger) : BulletPerManeger).angle = that.angle + i * Math.PI / 12;
        ...
        refreshData() {
          ...
          this.GuangziLivSysMag.harmValue = HarmValue; //获取差值

          var subValue = LivingValue - this.GuangziLivSysMag.livingValue;
          this.GuangziLivSysMag.livingValue = LivingValue; //把差值加上
...
//# sourceMappingURL=08a48802f849f2056a616cea4099cb88ea2cc934.js.map