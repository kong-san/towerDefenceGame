        ...
        underFire(Collider) {
          ...
          if (Collider.node.name == "Bullet_Pre") {
            ...
            if (this.ShenMuLivSysMag.livingValue - 80 <= 0) {
              ...
              this.node.parent.getChildByName("ProgressBar").getComponent(ProgressBar).progress = 0.5 * (this.ShenMuLivSysMag.livingValue / 100);
            }
          }
        }
...
//# sourceMappingURL=96fec514903e837946e59d9ee26da048d3f60558.js.map