System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, Prefab, instantiate, _dec, _class, _crd, ccclass, property, PaoPerManeger;
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec(_class = class PaoPerManeger extends Component {
        ...
        update(deltaTime) {
          ...
          for (var i = 0; i < this.bulletArray.length; i++) {
            ...
            _x = _x - 500 * deltaTime;
            _y = _y + 500 * deltaTime;
            node.setPosition(_x, _y, 0); //TODO:出屏幕后销毁
          }
        }
          ...
          resources.load("perfabs/Bullet_Pre", Prefab, (err, Prefab) => {
            if (!Prefab) {
              ...
              if (!node) {
                ...
                // console.log(node)
                // let pos = new Vec2();
                node.layer = Layers.Enum.UI_2D; // let x = that.node.position.x + 400;
...
//# sourceMappingURL=822370fb436bce267e379fd8e37c1ed418fb69a8.js.map