      ...
      _export("scrollControl", scrollControl = (_dec = ccclass('scrollControl'), _dec(_class = class scrollControl extends Component {
        ...
        touchMove(event) {
          ...
          if (event.getLocation().x < this.touchStartPos.x) {
            ...
            if (this.leftScroll + 50 < 101) {
              console.log("正在滑动");
              var x = this.node.position.x;
              var y = this.node.position.y;
              this.node.setPosition(x - 50, y, 0);
              this.leftScroll += 10;
            } else {}
          }
          ...
          if (event.getLocation().x > this.touchStartPos.x) {
            ...
            if (this.rightScroll + 50 < 101) {
              console.log("正在滑动");
              var _x = this.node.position.x;
              var _y = this.node.position.y;
              this.node.setPosition(_x + 50, _y, 0);
              this.rightScroll += 10;
            } else {}
          }
        }
...
//# sourceMappingURL=bef5b69cacc4eb7780453ff73bf0961a358f992e.js.map