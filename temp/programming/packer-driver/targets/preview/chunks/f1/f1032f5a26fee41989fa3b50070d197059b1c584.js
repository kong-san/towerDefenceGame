System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, PhysicsSystem2D, EPhysics2DDrawFlags, Contact2DType, Collider2D, PaoState, ToolStateManeger, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, toolPyManeger;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ToolStateManeger = _unresolved_3.ToolStateManeger;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("toolPyManeger", toolPyManeger = (_dec = ccclass('toolPyManeger'), _dec2 = property(_crd && ToolStateManeger === void 0 ? (_reportPossibleCrUseOfToolStateManeger({
        ...
        start() {
          //绘制物理信息
          this.ToolStateManeger = null; // this.ToolStateManeger = find
          //注册单个碰撞体的回调函数
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体开始接触时被调用一次
          this.ToolStateManeger = selfCollider.node.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
            error: Error()
          }), PaoState) : PaoState).ToolStateManeger;
          this.ToolStateManeger.step = 1;
          this.ToolStateManeger.master = otherCollider.node.name;
          selfCollider.node.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
            error: Error()
          }), PaoState) : PaoState).ToolStateManeger = this.ToolStateManeger;
          console.log('Tool onBeginContact', this.ToolStateManeger.master);
        }

        onEndContact(selfCollider, otherCollider, contact) {
          // 只在两个碰撞体结束接触时被调用一次
          console.log('Tool onEndContact');
          this.ToolStateManeger = selfCollider.node.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
            error: Error()
          }), PaoState) : PaoState).ToolStateManeger;
          ...
          selfCollider.node.getComponent(_crd && PaoState === void 0 ? (_reportPossibleCrUseOfPaoState({
            error: Error()
          }), PaoState) : PaoState).ToolStateManeger = this.ToolStateManeger; // selfCollider.node.destroy();
...
//# sourceMappingURL=f1032f5a26fee41989fa3b50070d197059b1c584.js.map