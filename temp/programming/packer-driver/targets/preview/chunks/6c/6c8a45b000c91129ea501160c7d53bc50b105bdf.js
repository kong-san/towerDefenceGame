        ...
        start() {
          ...
          this.node.on(Node.EventType.TOUCH_MOVE, event => {
            ...
            if (this.node.parent.parent.parent.getChildByName('pao1')) {
              ...
              var currentNode = this.node.parent.parent.parent.getChildByName('pao1'); //event.touch._point获得的鼠标位置是相对画布左下角的，而当前的锚点是在正中心
              //TODO：增加防抖操作

              console.log(event.getLocationX(), event.getLocationY()); //触摸点的世界坐标
              // let pos = new Vec3(event.getLocationX(),event.getLocationY(),0);

              var pos = new Vec3(event.touch._point['x'], event.touch._point['y'], 0); // console.log('changabefore',pos)
              //转换为UI作表
...
//# sourceMappingURL=6c8a45b000c91129ea501160c7d53bc50b105bdf.js.map