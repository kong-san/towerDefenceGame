    ...
    execute: function () {
      ...
      _export("KongperManeger", KongperManeger = (_dec = ccclass('KongperManeger'), _dec(_class = class KongperManeger extends Component {
        ...
        underFire(Collider) {
          ...
          var that = this;
          console.log("攻击值为", harmedValue * this.livingValue);

          if (Collider.node.name == "Wei_Per") {
            this.schedule(function () {
              console.log("空降兵还剩", that.currentLivingValue);
              console.log("总血量为", that.livingValue);
...
//# sourceMappingURL=5b78926a4397fb7645b5ae7a3f04586aa9182518.js.map