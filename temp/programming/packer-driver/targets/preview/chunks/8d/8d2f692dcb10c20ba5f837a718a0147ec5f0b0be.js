System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'resources', 'SpriteFrame', 'Layers', 'find', 'Vec2', 'BoxCollider2D']);
          ...
          if (this.node.parent.parent.parent.getChildByName(this.toolname)) {
            ...
            resources.load(spriteFramePath, SpriteFrame, (_err, spriteFrame) => {
              ...
              node.addComponent(_crd && toolPyManeger === void 0 ? (_reportPossibleCrUseOftoolPyManeger({
                error: Error()
              }), toolPyManeger) : toolPyManeger); // node.addComponent(PaoState)
...
//# sourceMappingURL=8d2f692dcb10c20ba5f837a718a0147ec5f0b0be.js.map