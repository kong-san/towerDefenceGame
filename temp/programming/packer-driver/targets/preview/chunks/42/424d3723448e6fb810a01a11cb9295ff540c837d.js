          ...
          resources.load("perfabs/PaoBulletPer", Prefab, (err, Prefab) => {
            if (!Prefab) {
              ...
              if (!node) {
                ...
                var y = that.node.position.x + 225; //速度；

                node.getComponent(_crd && BulletPerManeger === void 0 ? (_reportPossibleCrUseOfBulletPerManeger({
                  error: Error()
                }), BulletPerManeger) : BulletPerManeger).speed = that.SanShePaoLivSysMag.attackSpeed; // let shit = pos.set(x,y)
                // x = shit.x - 800;                   
                // y = shit.y - 450;
...
//# sourceMappingURL=424d3723448e6fb810a01a11cb9295ff540c837d.js.map