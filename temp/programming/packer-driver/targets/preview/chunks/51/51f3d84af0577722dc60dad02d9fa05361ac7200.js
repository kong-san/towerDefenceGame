System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, PhysicsSystem2D, EPhysics2DDrawFlags, Collider2D, Contact2DType, resources, Layers, find, Prefab, instantiate, ProgressBar, NodePool, BulletPerManeger, combatConfigManeger, livingSystemManeger, targetManeger, updateComponent, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, PaoPerManeger;
    ...
    execute: function () {
      ...
      _export("PaoPerManeger", PaoPerManeger = (_dec = ccclass('PaoPerManeger'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        refreshData() {
          ...
          this.SanShePaoLivSysMag.gradeValue++;
        ...
        initialSanshePao() {
          ...
          this.SanShePaoLivSysMag = new (_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
            error: Error()
          }), livingSystemManeger) : livingSystemManeger)(LivingValue, HarmValue, DefendValue, 1, AttackSpeed);
...
//# sourceMappingURL=51f3d84af0577722dc60dad02d9fa05361ac7200.js.map