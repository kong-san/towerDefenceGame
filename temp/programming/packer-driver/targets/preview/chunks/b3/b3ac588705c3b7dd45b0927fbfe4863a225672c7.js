    ...
    execute: function () {
      ...
      _export("diji", diji = (_dec = ccclass('diji'), _dec2 = property(_crd && livingSystemManeger === void 0 ? (_reportPossibleCrUseOflivingSystemManeger({
        ...
        update(deltaTime) {
          ...
          this.endGameFlag = find("Canvas/GlobalRoundcontrol").getComponent(_crd && combatConfigManeger === void 0 ? (_reportPossibleCrUseOfcombatConfigManeger({
            error: Error()
...
//# sourceMappingURL=b3ac588705c3b7dd45b0927fbfe4863a225672c7.js.map