    ...
    execute: function () {
      ...
      _export("infoManeger", infoManeger = (_dec = ccclass('infoManeger'), _dec(_class = (_class2 = class infoManeger extends Component {
        ...
        refreshInfo(toolType, node) {
          if (toolType == 1) {
            console.log("文字信息打印");
            node.getChildByName("name").getComponent(Label).string = this.SanShePaoInfo.name; // node.getChildByName("describeLabel").getComponent(Label).string = this.SanShePaoInfo.describe;
          }
...
//# sourceMappingURL=b3e52011d1438cbb068d1f5bf316eac0f0019148.js.map