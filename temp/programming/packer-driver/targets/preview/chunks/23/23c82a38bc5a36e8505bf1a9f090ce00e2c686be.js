    ...
    execute: function () {
      ...
      _export("KongperManeger", KongperManeger = (_dec = ccclass('KongperManeger'), _dec(_class = class KongperManeger extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (otherCollider.node.name == "Pao_Pre" || otherCollider.node.name == "Dan_Pre" || otherCollider.node.name == "GuangZi_Pre" || otherCollider.node.name == "GuangZi_Pre") {
            //攻击态；
            this.arrived = 2;
          }
        }
...
//# sourceMappingURL=23c82a38bc5a36e8505bf1a9f090ce00e2c686be.js.map